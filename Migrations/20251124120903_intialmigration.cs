        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietPlans_Trainees_TraineeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutPlans_Trainees_TraineeId",
                        column: x => x.TraineeId,
                        principalTable: "Trainees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@gym.com", "admin123", "Admin", "admin" },
                    { 2, "trainer@gym.com", "trainer123", "Trainer", "trainer" },
                    { 3, "trainee@gym.com", "trainee123", "Trainee", "trainee" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_TraineeId",
                table: "DietPlans",
                column: "TraineeId");
